...
namespace App\Filament\Resources\InspirationComments;
...
use App\Filament\Resources\InspirationComments\Pages\ListInspirationComments;
...
class InspirationCommentResource extends Resource
{
    ...
    {
        return [
            'index' => ListInspirationComments::route('/'),
        ];
    }
