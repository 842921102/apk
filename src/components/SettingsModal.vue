<template>
    <div v-if="isVisible" class="fixed inset-0 bg-black bg-opacity-50 z-50">
        <div class="bg-white w-full h-full flex flex-col md:flex-row">
                ...
                <div class="h-full md:flex md:w-full md:overflow-hidden">
                    ...
                    <div class="h-full overflow-y-auto md:flex md:w-full md:h-full">
                        ...
                        <div class="md:flex-1 md:h-full md:flex md:flex-col p-4 md:p-0">
                            ...
                            <div class="w-full space-y-6 md:flex-1 md:overflow-y-auto md:px-6 md:py-4 md:pr-8">
                                ...
                                <div class="bg-white border border-gray-200 rounded-lg p-4 md:p-6">
                                    ...
                                    <div class="space-y-4">
                                        <!-- API地址 -->
                                        <div>
                                            <label class="app-label !mb-2 text-sm">API地址</label>
                                            <input
                                            ...
                                            />
                                            <p class="app-form-hint">基础API地址，系统会自动添加 /chat/completions 路径</p>
                                        </div>

                                        <!-- 配置项网格 -->
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                <label class="app-label !mb-2 text-sm">API密钥</label>
                                                <input
                                            ...
                                            <div>
                                                <label class="app-label !mb-2 text-sm">模型名称</label>
                                                <input
                                            ...
                                            <div>
                                                <label class="app-label !mb-2 text-sm">温度参数 (0-1)</label>
                                                <input
                                                    ...
                                                    class="app-input text-sm"
                                                />
                                                <p class="app-form-hint">控制回答的创造性，0.7为推荐值</p>
                                            </div>

                                            <div>
                                                <label class="app-label !mb-2 text-sm">超时时间 (毫秒)</label>
                                                <input
                                ...
                                <div class="bg-white border border-gray-200 rounded-lg p-4 md:p-6">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            />
                                            <p class="app-form-hint">图片生成API的完整地址，包含具体的端点路径</p>
                                        </div>
                            ...
                            <!-- PC端：右侧区域底部按钮 -->
                            <div class="hidden md:flex justify-end gap-3 px-6 py-4 border-t border-app-line bg-app-page/80 flex-shrink-0">
                                <AppButton variant="secondary" size="sm" @click="resetToDefault">恢复默认</AppButton>
                                <AppButton variant="primary" size="sm" @click="saveSettings">保存设置</AppButton>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- 移动端：固定底部按钮 -->
            <div class="md:hidden flex justify-end gap-3 px-4 py-3 border-t border-app-line bg-app-page/80 flex-shrink-0">
                <AppButton variant="secondary" size="sm" @click="resetToDefault">恢复默认</AppButton>
                <AppButton variant="primary" size="sm" @click="saveSettings">保存设置</AppButton>
            </div>
        </div>
